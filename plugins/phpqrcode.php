<?php
/* This plugin generates QR codes used for sharing boards. */
...
$context->hooks->register("echo_qrCode", function (array &$vars) {
    ...
    // it when downloading, else using no margin since the page is expected
    // to supply light background and align it with the content.
    QRcode::png($data, false, QR_ECLEVEL_M, $large ? 6 : 3, $large);
    $vars["headers"][] = "Content-Type: image/png";
    return true;
});

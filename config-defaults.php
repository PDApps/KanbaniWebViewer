...
return [
    ...
    // Use null to prevent joining profiles (allow web only access).
    //
    // $baseQrCode = new QrCodeData;
    // $baseQrCode->mode = QrCodeData::...;
    // $baseQrCode->transport = new QrCodeWebDAV('https://example.com',
